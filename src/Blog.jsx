  ...
  return (
    <div>
      ...
      <div className="blog-container">
        ...
        <div className="blog--writing">
          ...
          <p>
            ...
            programming languages support various paradigms, the most well-known
            of which being Object-Oriented and Functional Programming. Although
            JavaScript can be both. Today in this blog, we will un...
          </p>
      ...
      <div className="blog-container">
        ...
        <div className="blog--writing">
          <h2 className="blog--title">Conditional Statements in JavaScript</h2>
          <p>
            ...
            There are various ways that we, as programmers, can control the flow
            or execution of a program today, we'll go through the Co...
          </p>
          <div className="blog--readmore">
