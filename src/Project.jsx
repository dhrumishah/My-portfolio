          ...
          <div className="project--container">
            <div className="project--desc">
              ...
              <div className="desc--para-2">
                <p>
                  A Meme Generator App made with ReactJS. It basically generates
                  a random meme when you apply top and bottom text.
                </p>
                <img
          ...
          <div className="project--container">
            ...
            <div className="project--desc">
              ...
              <div className="desc--para-3">
                <p>
                  A basic clone app of AirBnb website. It's made with React.
                </p>
                <img
                  className="project--links"
                  src={Github}
